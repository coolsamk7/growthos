...
import { MasterItemEntity, MasterLearningPathEntity, MasterModuleEntity } from '@growthos/nestjs-database/entities'
...
export class SeedDbCommand extends CommandRunner {
    ...
    mapType( type: string ): ItemType {
        return ItemType.PROBLEM;
    }
    mapDifficulty( diff: string ): Difficulty {
