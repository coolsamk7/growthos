                ...
                <div className="mx-auto max-w-7xl px-4 text-center">
                    <div className="mx-auto max-w-3xl">
                        ...
                        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
                            The all-in-one platform for structured learning and progress analytics.
                            Create custom paths, track your streaks, and achieve your learning goals.
                        </p>
                ...
                <div className="mx-auto max-w-7xl px-4">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                            Powerful features designed to help you stay focused, track progress,
                            and achieve your learning goals faster.
                        </p>
                    </div>
            ...
            <section className="bg-muted/50 py-24">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                            Whether you are preparing for interviews, learning new skills, or
                            studying for exams, GrowthOS adapts to your needs.
                        </p>
                    </div>
