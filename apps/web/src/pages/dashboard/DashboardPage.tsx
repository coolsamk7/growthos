...
import { statsData, weeklyStudyData, progressByCategory, recentActivity } from '@/services/mockData';
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div>
                ...
                <p className="mt-1 text-muted-foreground">Track your learning progress and stay consistent.</p>
            </div>
                        ...
                        {recentActivity.map( ( activity ) => (
                            ...
                            >
                                <div className="flex-1">
                                    ...
                                    <p className="mt-1 text-sm text-muted-foreground">{activity.path}</p>
                                </div>
