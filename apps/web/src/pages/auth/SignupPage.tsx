                ...
                <div className="max-w-md px-8 text-center">
                    <div className="mb-8 flex justify-center">
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-2 -left-2 size-16 rounded-2xl bg-warning/20 flex items-center justify-center">
                                <svg
                    ...
                    <div className="mt-8 flex items-center justify-center gap-4">
                        <div className="flex -space-x-2">
                            {[ 1, 2, 3, 4 ].map( ( i ) => (
                                <div
                                    key={i}
                                    className="size-8 rounded-full border-2 border-muted bg-muted-foreground/20"
                                />
                            ) )}
                        </div>
